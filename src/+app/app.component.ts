...
@Component({
  ...
  styles: [`
    * { padding:0; margin:0; font-family: 'Helvetica Neue', sans-serif; }
    ...
    nav { background: #551a8b; min-height:40px; border-bottom:5px #046923 solid; }
  ...
  <div class="hero-universal">
    <div class="inner-hero">
      <div>
        <span xLarge>Your name isL, {{ title }}!</span>
      </div>

      Enter Name: <input type="text" [value]="title" (input)="title = $event.target.value">
